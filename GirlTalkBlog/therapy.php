...
<body>
    ...
    <header>
        <div class="titlecontainer">
            <h1 style="text-shadow: 0px 4px 4px pink; color:rgb(114, 11, 37);"><strong>Therapy</strong></h1>
        </div>
        <div class="headerimage">
            <img src="../images/happylife.jpg" alt="image" height="150px" width="50%">
        </div>
    </header>
    <br />
    ...
    <main class="maincontentcontainer">
        ...
        <p>
            <strong><em>Start Healing, </em></strong> <br /> <br />
            <img src="../images/therapymind.jpg" alt="image" height="150px" width="300px"> <br /> <br />
        ...
        <p>
            ...
            <img src="../images/health.jpg" alt="image" height="300px" width="400px">
